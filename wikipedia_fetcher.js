// wikipedia_fetcher.js - Handles fetching text data directly from Wikipedia
const WikipediaAPI = {
    // Fetches text content from a Wikipedia page title
    async fetchArticle(pageTitle) {
        // Correct endpoint format with en subdomain and w/api path
        ...
        const params = new URLSearchParams({
            ...
            page: cleanTitle,
            format: "json",
            origin: "*", // Tells Wikipedia it is okay to share data with GitHub Pages
            prop: "text",
